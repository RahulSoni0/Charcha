...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permission();// a function which will ask for permissions
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(title)){
                    title_blog.setError("Kuch kasht kariye");
                }
                else if(TextUtils.isEmpty(description)){
                    description_blog.setError("Man ki baat likh do. Sharmayo nahi");
                }
                else{
                    uploadData(title,description);//this method will upload our post to firebase
                }
            }
        });
    }
            ...
            reference.putBytes(data)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            while (!uriTask.isSuccessful());;  //#### CHECK FOR ERRORS due to incompleteness
    ...
    private void galleryPick() {
        ...
        intent.setType("image/*");//to consider all types of images for uploading
